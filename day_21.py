...
def main():
    monster_stats = int(input().split()[-1]), int(input().split()[-1]), int(input().split()[-1])

    print(part_1(monster_stats))
    print(part_2(monster_stats))


def part_1(monster_stats):
    return min(weapon_cost + armor_cost + ring_1_cost + ring_2_cost
               ...
               monster_stats[0] / max(weapon_damage + ring_1_damage + ring_2_damage - monster_stats[2], 1)
               <= 100 / max(monster_stats[1] - armor_armor - ring_1_armor - ring_2_armor, 1))


def part_2(monster_stats):
